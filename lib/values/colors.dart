...
class AppColors {
  ...
  static const Color klmaidaGreen = Color.fromRGBO(76, 217, 100, 1);
  static const Color klmaidaYellow = Color(0xFFFFCC00);

//  static const Color klmaidaGoldRatingStar = Color(0xFFFFCC00);
  static const Color klmaidaGreyRatingStar = Color(0xFFDFE4ED);
  static const Color klmaidaSkyBlue = Color(0xFFEEF7FF);
  static const Color klmaidaDarkBackground = Color(0xFF25262E);
  static const Color klmaidaUnselectedSliderDot = Color(0xFF6A6A6A);
